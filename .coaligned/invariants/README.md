...
`npx coaligned invariants` discovers and runs every `*.rules.mjs` module in this
...
No rule modules exist yet. Author the first with the `coaligned-invariant` skill.
