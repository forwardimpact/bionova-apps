...
| 16 | An open/draft spec PR is not linkage — only `spec.md` merged to `main` clears the label | a live-case fixture — #130, linked only via open PR #171 (spec 150, `spec.md` not yet on `main`) — is NOT cleared; it RETAINs until #171 merges |
